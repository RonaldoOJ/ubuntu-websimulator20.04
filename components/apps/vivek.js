        ...
        return (
            <>
                <div id="about" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "about" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="about ronaldo" src="./themes/Yaru/status/about.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">About Me</span>
                </div>
                <div id="education" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "education" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="ronaldo' education" src="./themes/Yaru/status/education.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Education</span>
                </div>
                <div id="skills" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "skills" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="ronaldo' skills" src="./themes/Yaru/status/skills.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Skills</span>
                </div>
                <div id="projects" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "projects" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="ronaldo' projects" src="./themes/Yaru/status/projects.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Projects</span>
                </div>
                <div id="resume" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "resume" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="ronaldo's resume" src="./themes/Yaru/status/download.svg" />
    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/bitmoji.png" alt="Ronaldo Olvera Jiménez Logo" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Ronaldo Olvera Jiménez</span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-pink-600 font-bold">Computer Systems Engineer!</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className=" font-medium">Graduate Student</span> currently Computer Systems Engineer. I've completed my 6 month intern in my <u className=' cursor-pointer '> <a href="https://en.wikipedia.org/wiki/HackerRank" target={"_blank"}>professional residency</a> </u>, and now I'm looking for full-time AI, fullstack and frontend engineer roles! ( Hit me up <a className='text-underline' href='mailto:vivek.p9737@gmail.com'><u>@vivek.p9737@gmail.com</u></a> :) )</li>
                <li className=" mt-3 list-building"> I enjoy building awesome softwares that solve practical problems.</li>
                <li className=" mt-3 list-time"> When I am not coding my next project, I like to spend my time reading books, playing COD, Valorant or listening <a href="https://www.youtube.com/channel/UCBa659QWEk1AI4Tg--mrJ2A" target="_blank" rel="noreferrer"> my fav music.</a></li>
                <li className=" mt-3 list-star"> And I also have interest in Machine Learning & AI !</li>
            </ul>
        </>
    )
}
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                <li className="list-disc">
                    ...
                    <div className=" text-sm md:text-base">Computer Systems Engineering</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">GPA &nbsp; 91.19/100</div>
                </li>
                <li className="list-disc">
                    ...
                    <div className=" text-sm md:text-base">Networks & Software Technology</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">GPA &nbsp; 91.19/100</div>
                </li>
                <li className="list-disc mt-5">
                    ...
                    <div className="text-sm text-gray-300 font-bold mt-1">GPA &nbsp; 90/100</div>
                </li>
            </ul>
        </>
    )
    ...
    return (
        <>
            ...
            <ul className=" tracking-tight text-sm md:text-base w-10/12 emoji-list">
                ...
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <div> My areas of expertise are <strong className="text-ubt-gedit-orange">IA, IoT, Cloud Engineering, fullstack dev, front-end development, React.js & javascript!</strong></div>
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
...
function Projects() {
    return (
        <>
            ...
            {/* Featured Project */}
            <div className="w-5/6 md:w-3/4 border border-gray-50 border-opacity-10 rounded p-4 mb-4 hover:bg-gray-50 hover:bg-opacity-5 transition duration-150">
                <div className="text-lg md:text-xl font-bold mb-2">
                    3D VR Scenario – Three.js
                </div>

                <p className="text-sm md:text-base text-gray-200 leading-tight">
                    Interactive 3D environment with VR support built using Three.js.
                    Designed for immersive visualization and virtual reality experiences.
                </p>

                <div className="flex flex-col md:flex-row gap-3 mt-3 text-sm">
                    <a
                        href="https://ronaldooj.github.io/graf-threejsEscenario3D-VR/"
                        target="_blank"
                        rel="noreferrer"
                    ...
                    <a
                        href="https://github.com/RonaldoOJ/graf-threejsEscenario3D-VR.git"
                        target="_blank"
                        rel="noreferrer"
                        className="text-blue-400 underline"
                    >
            ...
            {/* GitHub Repositories */}
            <a
                href="https://github.com/RonaldoOJ?tab=repositories"
                target="_blank"
                rel="noreferrer"
                className="w-5/6 md:w-3/4 border border-gray-50 border-opacity-10 rounded p-4 hover:bg-gray-50 hover:bg-opacity-5 transition duration-150"
            >
                <div className="text-lg md:text-xl font-bold mb-2">
                ...
                <p className="text-sm md:text-base text-gray-200 leading-tight">
                    Explore all my public repositories including academic projects,
                    frontend & fullstack applications, AI experiments and system-level work.
                </p>

                <div className="mt-3 text-sm text-blue-400 underline">
                    github.com/RonaldoOJ
                </div>
            </a>
        </>
    );
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/Vivek-Patel-Resume.pdf" title="Ronaldo patel resume" frameBorder="0"></iframe>
    )
}